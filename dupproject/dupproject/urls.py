...
urlpatterns = [
    ...
    path("dashboard/sales/add/",views.admin_save_sale,name="admin_save_sale"),
    path("dashboard/sales/receipt/<int:sale_id>/",views.admin_view_receipt,name="admin_view_receipt"),
    path("dashboard/sales/edit/<int:sale_id>/",views.admin_edit_sale,name="admin_edit_sale"),
    path("dashboard/sales/payment/<int:sale_id>/",views.admin_add_payment,name="admin_add_payment"),
    path("dashboard/deposits/",views.admin_deposit_list,name="admin_deposit_list"),
    path("dashboard/deposits/add/",views.admin_add_deposit,name="admin_add_deposit"),
    path("dashboard/deposits/receipt/<int:deposit_id>/",views.admin_view_deposit_receipt,name="admin_view_deposit_receipt"),
    path("dashboard/deposits/history/<str:customer_name>/<str:item_name>/",views.admin_deposit_history,name="admin_deposit_history"),
    #  Sales 
